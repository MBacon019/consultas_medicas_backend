...
from clinic.serializers.user import (
    UserSerializer,
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def change_password(self, request):
        ...
        request.user.save()
        return Response({'message': 'Contraseña actualizada. Por favor inicie sesión nuevamente.'})
    ...
    def toggle_active(self, request, pk=None):
        ...
        return Response({'message': f'Usuario {estado}.', 'is_active': user.is_active})
